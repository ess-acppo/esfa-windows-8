...
function loadActivityDataAH() {
    if (ActivityDataAH.activities && ActivityDataAH.activities.length > 0) {
...
function loadAHRefCodes() {
    ...
    $("#form1").find('#lstSyndromes').find('option').remove().end().append($('<option value="NONE">- select -</option>'));
...
function refreshActivityDataAH(str) {
    ...
    if (arr && arr.length > 0) {
        ...
        $("#form1").find('select[name="SiteId_O_N"]').find('option').remove().end();
        $.each(siteData, function (key, val) {
            var option = $('<option />');
            option.attr('value', val.id).text(val.name);
            $("#form1").find('select[name="SiteId_O_N"]').append(option);
            ...
            if (def && def.length > 0) {
                $.each(def[0].collectSamples, function (key, val) { //For each default Sample
                    ...
                    $.each(val.testFors, function (key3, val3) {
                        divTestTypes.find('input[type="checkbox"][name^="PTestFor_M_S_' + samples + '_' + val3 + '_"].minimal').prop("checked", true);
...
$(document).on('click', '#addSyndrome', function (e) {
    var str = $('#lstSyndromes option:selected').val();
    if (str !== 'NONE') {
        syndromes = syndromes + 1;
        var that = $(syndrome);
...
$(document).on('click', '#addGSyndrome', function (e) {
    ...
    if (str !== 'NONE') {
        ...
        that.find("input[name^='YSyndromeComments_M_S']").attr("name", "YSyndromeComments_M_S_" + syndromes + "_2");
    ...
    $.confirm({
        ...
        buttons: {
            Ok: function () {
                syndromes = syndromes - 1;
                var option = $('<option />');
                option.attr('value', x.closest('.syndromeX').find('input[name^="XSyndromeCode_M_S"]').val()).text(x.closest('.syndromeX').find('label[name^="XSyndromeText_M_S"]').text());
    ...
    $.confirm({
        ...
        buttons: {
            Ok: function () {
                syndromes = syndromes - 1;
                var option = $('<option />');
                option.attr('value', x.closest('.syndromeY').find('input[name^="YSyndromeCode_M_S"]').val()).text(x.closest('.syndromeY').find('label[name^="YSyndromeText_M_S"]').text());
                $('#lstSyndromes').append(option);
...
$(document).on('click', '#noSyndromes', function (e) {
    $('.defSyndromeX').find('input[type=radio][name^="SyndromeFlag_M_S"][data-code="N"]').prop("checked", true);
...
$(document).on('click', '#btnNAD', function (e) {
    $(':radio[name^=INFlag_M_S]').eq(1).prop("checked", true);
    $(':radio[name^=HNFlag_M_S]').eq(1).prop("checked", true);
    $(':radio[name^=THFlag_M_S]').eq(1).prop("checked", true);
    $(':radio[name^=ABFlag_M_S]').eq(1).prop("checked", true);
    $(':radio[name^=MUFlag_M_S]').eq(1).prop("checked", true);
});
...
function loadModalAH(pagename) {
    $.ajax({
        ...
        $('#form1').find("input[type='checkbox'].minimal").prop("checked", false).val('N');
        $('#form1').find("input[type='radio'].minimal").prop("checked", false);
            ...
            if (curIdx > -1) {
                ...
                $.each(data, function (key, value) {
                    ...
                    if (key.startsWith("externalObserverFlag_O_S") && value === "Y") {
                        ...
                        $('#form1').find("input[type='checkbox'][name^='externalObserverFlag_O_S']").prop("checked", true);
                    }
                    if (key.startsWith("externalObserverFlag_O_S") && value === "N") {
                        $('#form1').find("input[name='externalObserver_O_S']").addClass('hide');
                        $('#form1').find("input[type='checkbox'][name^='externalObserverFlag_O_S']").prop("checked", false);
                    }
                    if (key === "gender_M_S" && value !== "") {
                        $('#form1').find("input[type='radio'][name='" + key + "'][value='" + value + "']").prop("checked", true);
                    }
                    ...
                    if (key.startsWith("postMortemConducted_M_S") && value !== "") {
                        if (value === "Y") {
                            $('#form1').find("input[type='radio'][name='" + key + "'][value='Y']").prop("checked", true);
                            $('#tabPM').removeClass('hide');
                            reAdjust();
                        }
                        if (value === "N") {
                            $('#form1').find("input[type='radio'][name='" + key + "'][value='N']").prop("checked", true);
                            $('#tabPM').addClass('hide');
                            reAdjust();
                        }
                    }
                    ...
                    if (key.startsWith('PTestFor')) {
                        ...
                        if (value === 'Y') {
                            $('#form1').find("input[type='checkbox'][name='" + key + "']").prop("checked", true);
                            $('#form1').find("input[type='checkbox'][name='" + key + "']").val('Y');
                        }
                    }
                    if (key.startsWith('TestFor')) {
                        var newTestFor = $(testFor);
                        newTestFor.find('input').attr('name', key);
                        newTestFor.find('label').text(key.split('_')[6]);
                        $('#form1').find('.sample').eq(samples - 1).find('div.testTypes').append(newTestFor);
                    ...
                    $('#form1').find("input[type='checkbox'][name='" + key + "'][value='Y']").prop("checked", true);
                    $('#form1').find("input[type='checkbox'][name='" + key + "'][value='N']").prop("checked", false);
                    //$('#form1').find("input[type='radio'][name='" + key + "'][value='" + value + "']").prop("checked", true);
                ...
                $('#form1').find("input[type='radio'][name='obsProximity_M_S_0_1'][value='AR']").prop("checked", true);
                $('#form1').find("input[type='radio'][name='optSyndromes_M_S_0_2'][value='N']").prop("checked", true);
                $('#form1').find("input[type='radio'][name='woundsPresentG_M_S_0_2'][value='N']").prop("checked", true);
                $('#form1').find("input[type='number'][name='maleNumber_M_N_0_2']").val(0);
                $('#form1').find("input[type='number'][name='femaleNumber_M_N_0_2']").val(0);
...
function preValidateAH() {
    var woundsFlag = 0;
    var postMortemFlag = 0;
    var selManFields = $("#form1").find('select[name*="_M_N"]');
    $.each(selManFields, function (index, v) {
        ...
        if (v.value === "" || v.value === "0" || v.value === "NONE") {
            vError = 1;
    ...
    var selStrManFields = $("#form1").find('select[name*="_M_S"]');
    $.each(selStrManFields, function (index, v) {
        var fname = v.name.split("_")[0];
        var fMOC = v.name.split("_")[1];
        var fNSD = v.name.split("_")[2];
        var fnum = v.name.split("_")[3];
    ...
    $.each(strManFields, function (index, v) {
        ...
        var fnum = v.name.split("_")[3];
        var ftype = v.name.split("_")[4];
        if (fname === 'woundsPresent' && $("[name='" + v.name + "']:checked").val() === 'Y') {
            woundsFlag = 1; return true;
        }
        if (fname === 'woundsPresent' && $("[name='" + v.name + "']:checked").val() === 'N' || v.value === '') {
            woundsFlag = 0; return true;
        }
        if (fname === 'woundsPresentG' && $("[name='" + v.name + "']:checked").val() === 'Y') {
            woundsFlag = 1; return true;
        }
        if (fname === 'woundsPresentG' && $("[name='" + v.name + "']:checked").val() === 'N' || v.value === '') {
            woundsFlag = 0; return true;
        }
        if (fname === 'maggotsPresent' && $("[name='" + v.name + "']:checked").val() === 'Y' && woundsFlag === 0) {
            vError = 1;
            vErrDescription.push("<a href='#' class='btn btn-sm btn-default btnErrorAH' data-j='" + v.name + "' data-k='" + ftype + "' data-l='" + fnum + "'>Go</a>" + $('[name="' + v.name + '"]').data("name") + " field cannot be Yes.");
            vFailed = true;
            return false;
        }
        ...
        if (fname === 'ObservationWhereWktClob' && v.value !== '') {
            var wkt = new Wkt.Wkt();
            wkt.read(v.value);
            wkt.toObject();
        ...
        if (v.value === "") {
            if (fname === 'maggotsPresent' && woundsFlag === 0) return true;
            vError = 1;
            vErrDescription.push("<a href='#' class='btn btn-sm btn-default btnErrorAH' data-j='" + v.name + "' data-k='" + ftype + "' data-l='" + fnum + "'>Go</a>" + $('[name="' + v.name + '"]').data("name") + " field cannot be empty.");
            vFailed = true;
            return false;
        ...
        if ($("[name='" + v.name + "']").is(':radio') && $("[name='" + v.name + "']:checked").length === 0) {
            if (fname === 'maggotsPresent' && woundsFlag === 0) return true;
            if (fname === 'INFlag' && postMortemFlag === 0) return true;
            if (fname === 'HNFlag' && postMortemFlag === 0) return true;
            if (fname === 'THFlag' && postMortemFlag === 0) return true;
            if (fname === 'ABFlag' && postMortemFlag === 0) return true;
            if (fname === 'MUFlag' && postMortemFlag === 0) return true;
            vError = 1;
            vErrDescription.push("<a href='#' class='btn btn-sm btn-default btnErrorAH' data-j='" + v.name + "' data-k='" + ftype + "' data-l='" + fnum + "'>Go</a>" + $('[name="' + v.name + '"]').data("name") + " field cannot be empty.");
            vFailed = true;
            return false;
    ...
    var numManFields = $("#form1").find('input[name*="_M_N"]');
...
function IterateAH(data) {
    ...
    $.each(modData, function (index, value) {
        if (isNaN(index)) {
            ...
            if (fname === 'woundsPresent' && value === 'Y') {
                woundsFlag = 1; return true;
            }
            if (fname === 'woundsPresent' && value === 'N') {
                woundsFlag = 0; return true;
            }
            if (fname === 'woundsPresent' && value === '') {
                woundsFlag = 0; return true;
            }
            if (fname === 'woundsPresentG' && value === 'Y') {
                woundsFlag = 1; return true;
            }
            if (fname === 'woundsPresentG' && value === 'N') {
                woundsFlag = 0; return true;
            }
            if (fname === 'woundsPresentG' && value === '') {
                woundsFlag = 0; return true;
            }
            if (fname.startsWith('BodySystemCode')) {
                bodysystem = value;
            ...
            if (fname === bodysystem + 'GrossFindings' && value === '' && bodysystemFlag === 1 && postMortemFlag === 1) {
                vError = 1;
                vErrDescription.push("<a href='#' class='btn btn-sm btn-default btnErrorAH' data-j='" + index + "' data-k='" + ftype + "' data-l='" + fnum + "'>Go</a>" + $('[name="' + index + '"]').data("name") + " field cannot be empty.");
                vFailed = true;
                bodysystemFlag = 0;
            ...
            if (fname === 'gunkNumber') {
                ...
                if (adults + juveniles + acUnknown !== totNumber) {
                    vError = 1;
                    vErrDescription.push("<a href='#' class='btn btn-sm btn-default ripple btnErrorAH' data-j='adultNumber_M_N_0_0' data-k='2' data-l='0'>Go</a>Age Class numbers do not add up.");
                    vFailed = true;
                    return false;
                }
                if (adults + juveniles + acUnknown < 0) {
                    vError = 1;
                    vErrDescription.push("<a href='#' class='btn btn-sm btn-default ripple btnErrorAH' data-j='adultNumber_M_N_0_0' data-k='2' data-l='0'>Go</a>Invalid Age Class values.");
                    vFailed = true;
                    return false;
                }
                if (females + males + gUnknown !== totNumber) {
                    vError = 1;
                    vErrDescription.push("<a href='#' class='btn btn-sm btn-default ripple btnErrorAH' data-j='maleNumber_M_N_0_2' data-k='2' data-l='0'>Go</a>Gender field numbers do not add up.");
                    vFailed = true;
                    return false;
                }
            ...
            if (fname === 'SyndromeComments' && syndromesFlag === 1 && ftype === ftypeFlag && fnum === fnumFlag && value === '') {
                vError = 1;
            ...
            if (fname === 'TestFor') {
                if ($("input[type='checkbox'][name^='TestFor_M_S_" + fnum + "_']:checked").length === 0) {
                    vError = 1;
                    vErrDescription.push("<a href='#' class='btn btn-sm btn-default ripple btnErrorAH' data-j='" + index + "' data-k='S' data-l='" + fnum + "'>Go</a>" + "Minimum of one Pathogen/TestType should be selected per sample.");
                    vFailed = true;
                    return false;
                }
            }
            ...
            if (fname === 'PTestFor') {
                if ($("input[type='checkbox'][name^='PTestFor_M_S_" + fnum + "_']:checked").length === 0) {
                    vError = 1;
                    vErrDescription.push("<a href='#' class='btn btn-sm btn-default ripple btnErrorAH' data-j='" + index + "' data-k='S' data-l='" + fnum + "'>Go</a>" + "Minimum of one Pathogen/TestType should be selected per sample.");
                    vFailed = true;
                    return false;
            ...
            if (fname === 'postMortemConducted' && $("[name='" + index + "']:checked").val() === 'Y') {
                postMortemFlag = 1;
                return true;
            }
            ...
            if ((fname === 'SyndromesCount' || fname === 'XSyndromesCount' || fname === 'YSyndromesCount') && value > totNumber) {
                vError = 1;
                vErrDescription.push("<a href='#' class='btn btn-sm btn-default btnErrorAH' data-j='" + index + "' data-k='" + ftype + "' data-l='" + fnum + "'>Go</a>" + $('[name="' + index + '"]').data("name") + " cannot be greater than total number of animals.");
                vFailed = true;
                return false;
...
function Iterate2AH(data) {
    ...
    $.each(modData, function (index, value) {
        if (isNaN(index)) {
            ...
            if (fname === 'woundsPresent' && value === 'N' || value === '') {
                woundsFlag = 0; return true;
            }
            if (fname === 'woundsPresentG' && value === 'Y') {
                woundsFlag = 1; return true;
            ...
            if (fname === 'gunkNumber') {
                ...
                if (adults + juveniles + acUnknown !== totNumber) {
                    vError = 1;
                    vErrDescription.push("Age Class numbers do not add up.");
                    vFailed = true;
                    return false;
                }
                if (adults + juveniles + acUnknown < 0) {
                ...
                if (females + males + gUnknown !== totNumber) {
                    vError = 1;
                    vErrDescription.push("Gender field numbers do not add up.");
                    vFailed = true;
                    return false;
                }
                if (females + males + gUnknown < 0) {
...
$(document).on('blur', 'input.percentCal', function (e) {
    ...
    //diff1 = Number($("input[name='totalNumber_M_N']").val()) - Number($("input[name='adultNumber_M_N_0_2']").val()) - Number($("input[name='juvNumber_M_N_0_0']").val());
    //if (diff < 0 || diff1 < 0) {
    ...
    $("input[name='aunkNumber_M_N_0_0']").val(Number($("input[name='totalNumber_M_N']").val()) - Number($("input[name='adultNumber_M_N_0_0']").val()) - Number($("input[name='juvNumber_M_N_0_0']").val()));
    $("input[name='aunkPercent_O_N_0_2']").val(Math.round(Number($("input[name='aunkNumber_M_N_0_0']").val()) / Number(totalNum) * 100));
...
$(document).on('blur', 'input.totalNumber', function (e) {
    var that = $(this);
    if (that.val() > 0) {
        $("input[name='aunkNumber_M_N_0_0']").val(Number(that.val()) - Number($("input[name='adultNumber_M_N_0_0']").val()) - Number($("input[name='juvNumber_M_N_0_0']").val()));
        $("input[name='aunkPercent_O_N_0_2']").val(Math.round(Number($("input[name='aunkNumber_M_N_0_0']").val()) / Number(that.val()) * 100));
