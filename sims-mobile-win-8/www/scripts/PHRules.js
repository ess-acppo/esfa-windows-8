...
function loadBotanySample() {
    ...
    that.find("input[type='checkbox'].minimal").prop("checked", false).val('N');
    that.find("input[type='radio'].minimal").prop("checked", false);
    $('#samples').append(that);
            ...
            if (curIdx > -1) {
                ...
                $.each(data, function (key, value) {
                    ...
                    if (key === "AdditionalObserverTab" && value.length > 0) {
                        //$('#form1').find("input[type='checkbox'][name^='AdditionalObservers']").prop("checked", true);
                            ...
                            $.ajax({
                                ...
                                $.each(value1, function (key2, value2) {
                                    ...
                                    if (key2.startsWith("HostStatCount") && value2 > 0) {
                                        ...
                                        $('div.hostweed').eq(key1).find("input[type='radio'][name^='CountList'][value='Count']").prop("checked", true);
                                    }
                                    ...
                                    $('div.hostweed').eq(key1).find("input[type='checkbox'][name^='" + key2 + "'][value='Y']").prop("checked", true);
                                    $('div.hostweed').eq(key1).find("input[type='checkbox'][name^='" + key2 + "'][value='N']").prop("checked", false);
                                    $('div.hostweed').eq(key1).find("input[type='radio'][name^='" + key2 + "'][value='" + value2 + "']").prop("checked", true);
                            ...
                            $.ajax({
                                ...
                                $.each(value1, function (key2, value2) {
                                    ...
                                    if (key2.startsWith("HostStatCount") && value2 > 0) {
                                        ...
                                        $('div.entobox').eq(key1).find("input[type='radio'][name^='CountList'][value='Count']").prop("checked", true);
                                    }
                                    if (key2.startsWith("HostStatAreaNo") && value2 > 0) {
                                    ...
                                    $('div.entobox').eq(key1).find("input[type='checkbox'][name^='" + key2 + "'][value='Y']").prop("checked", true);
                                    $('div.entobox').eq(key1).find("input[type='checkbox'][name^='" + key2 + "'][value='N']").prop("checked", false);
                                    $('div.entobox').eq(key1).find("input[type='radio'][name^='" + key2 + "'][value='" + value2 + "']").prop("checked", true);
                                        ...
                                        $.each(value2, function (key3, value3) {
                                            $.ajax({
                                                ...
                                                $.each(value3, function (key4, value4) {
                                                    ...
                                                    $('div.entobox').eq(key1).find('div.entotarget').eq(key3).find("input[type='checkbox'][name^='" + key4 + "'][value='Y']").prop("checked", true);
                                                    $('div.entobox').eq(key1).find('div.entotarget').eq(key3).find("input[type='checkbox'][name^='" + key4 + "'][value='N']").prop("checked", false);
                                                    $('div.entobox').eq(key1).find('div.entotarget').eq(key3).find("input[type='radio'][name^='" + key4 + "'][value='" + value4 + "']").prop("checked", true);
                            ...
                            $.ajax({
                                ...
                                $.each(value1, function (key2, value2) {
                                    ...
                                    if (key2.startsWith("HostStatCount") && value2 > 0) {
                                        ...
                                        $('div.pathbox').eq(key1).find("input[type='radio'][name^='CountList'][value='Count']").prop("checked", true);
                                    }
                                    if (key2.startsWith("HostStatAreaNo") && value2 > 0) {
                                    ...
                                    $('div.pathbox').eq(key1).find("input[type='checkbox'][name^='" + key2 + "'][value='Y']").prop("checked", true);
                                    $('div.pathbox').eq(key1).find("input[type='checkbox'][name^='" + key2 + "'][value='N']").prop("checked", false);
                                    $('div.pathbox').eq(key1).find("input[type='radio'][name^='" + key2 + "'][value='" + value2 + "']").prop("checked", true);
                                        ...
                                        $.each(value2, function (key3, value3) {
                                            $.ajax({
                                                ...
                                                $.each(value3, function (key4, value4) {
                                                    ...
                                                    $('div.pathbox').eq(key1).find('div.pathtarget').eq(key3).find("input[type='checkbox'][name^='" + key4 + "'][value='Y']").prop("checked", true);
                                                    $('div.pathbox').eq(key1).find('div.pathtarget').eq(key3).find("input[type='checkbox'][name^='" + key4 + "'][value='N']").prop("checked", false);
                                                    $('div.pathbox').eq(key1).find('div.pathtarget').eq(key3).find("input[type='radio'][name^='" + key4 + "'][value='" + value4 + "']").prop("checked", true);
                            ...
                            $.ajax({
                                ...
                                $.each(value1, function (key2, value2) {
                                    ...
                                    if (key2 === "AdditionalCollectorTab") {
                                        ...
                                        if (value2.length > 0) {
                                            $('div.sample').eq(key1).find("input[type='checkbox'][name^='AdditionalCollectors']").prop("checked", true);
                                            $.each(value2, function (key3, value3) {
                                                $('div.sample').eq(key1).find("select[name^='AdditionalCollectorName']").eq(key3).val(value3);
                                            });
                                        } else { $('div.sample').eq(key1).find("input[type='checkbox'][name^='AdditionalCollectors']").prop("checked", false).val("N"); }
                                    }
                                    if (key2 === "PlantPreservationTab" && value2.length > 0) {
                                        $.each(value2, function (key3, value3) {
                                            $('div.sample').eq(key1).find("input[type='checkbox'][name^='" + key2 + "-" + value3 + "']").prop("checked", true);
                                        });
                                    }
                                    ...
                                    $('div.sample').eq(key1).find("input[type='checkbox'][name^='" + key2 + "'][value='Y']").prop("checked", true);
                                    $('div.sample').eq(key1).find("input[type='checkbox'][name^='" + key2 + "'][value='N']").prop("checked", false);
                                    $('div.sample').eq(key1).find("input[type='radio'][name^='" + key2 + "'][value='" + value2 + "']").prop("checked", true);
            ...
            $.each(curSiteData, function (key1, value1) {
                $.ajax({
                    ...
                    $.each(value1, function (key2, value2) {
                        ...
                        $('div.hostweed').eq(pkey).find("input[type='checkbox'][name^='" + key2 + "'][value='Y']").prop("checked", true);
                        $('div.hostweed').eq(pkey).find("input[type='radio'][name^='" + key2 + "'][value='" + value2 + "']").prop("checked", true);
                        ...
                        if (key2.startsWith("HostStatCount") && value2 > 0) {
                            ...
                            $('div.hostweed').eq(pkey).find("input[type='radio'][name^='CountList'][value='Count']").prop("checked", true);
                        }
                        if (key2.startsWith("HostStatAreaNo") && value2 > 0) {
            ...
            $.each(curSiteData, function (key1, value1) {
                $.ajax({
                    ...
                    $.each(value1, function (key2, value2) {
                        ...
                        $('div.entobox').eq(pkey).find("input[type='checkbox'][name^='" + key2 + "'][value='Y']").prop("checked", true);
                        $('div.entobox').eq(pkey).find("input[type='radio'][name^='" + key2 + "'][value='" + value2 + "']").prop("checked", true);
                        ...
                        if (key2.startsWith("HostStatCount") && value2 > 0) {
                            ...
                            $('div.entobox').eq(pkey).find("input[type='radio'][name^='CountList'][value='Count']").prop("checked", true);
                        }
                        if (key2.startsWith("HostStatAreaNo") && value2 > 0) {
            ...
            $.each(curSiteData, function (key1, value1) {
                $.ajax({
                    ...
                    $.each(value1, function (key2, value2) {
                        ...
                        $('div.pathbox').eq(pkey).find("input[type='checkbox'][name^='" + key2 + "'][value='Y']").prop("checked", true);
                        $('div.pathbox').eq(pkey).find("input[type='radio'][name^='" + key2 + "'][value='" + value2 + "']").prop("checked", true);
                        ...
                        if (key2.startsWith("HostStatCount") && value2 > 0) {
                            ...
                            $('div.pathbox').eq(pkey).find("input[type='radio'][name^='CountList'][value='Count']").prop("checked", true);
                        }
                        if (key2.startsWith("HostStatAreaNo") && value2 > 0) {
...
$(document).on('click', "#addPlant", function () {
    ...
    that1.find("input[type='checkbox'].minimal").prop("checked", false).val('N');
    that1.find("input[type='radio'].minimal").prop("checked", false);
...
$(document).on('change', 'input[type="checkbox"].minimal', function (event) {
...
$(document).on('click', 'input[type="radio"].minimal', function (event) {
    //alert(event.type + ' callback');
